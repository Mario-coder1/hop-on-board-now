...
const translations: Record<Lang, Dict> = {
  sk: {
    ...
    "trust.title": "Bezpečnosť na prvom mieste",
    "trust.verified": "Overené profily",
    "trust.verified.desc": "Každý užívateľ overený e-mailom",
    "trust.payment": "Bezpečná platba",
    "trust.payment.desc": "Šifrované transakcie cez Stripe",
    "trust.tracking": "Live sledovanie",
    "trust.tracking.desc": "Vidíš polohu vodiča v reálnom čase",
    "trust.support": "Podpora",
    "trust.support.desc": "Kontakt cez chat alebo e-mail",
    "quickstart.title": "Začni za 30 sekúnd",
    "quickstart.step1": "Zadaj e-mail a heslo",
    "quickstart.step2": "Over e-mailom",
    "quickstart.step3": "Nájdi alebo ponúkni jazdu",
    "quickstart.cta": "Vytvoriť účet",
    "download.title": "Maj TakeMe vždy po ruke",
    "download.desc": "Pridaj si aplikáciu na domovskú obrazovku. Rýchlejší prístup, push notifikácie aj offline.",
    "download.cta": "Ako nainštalovať",
  },
  cs: {
    "hero.badge_online": "online",
    ...
    "trust.title": "Bezpečnost na prvním místě",
    "trust.verified": "Ověřené profily",
    "trust.verified.desc": "Každý uživatel ověřen e-mailem",
    "trust.payment": "Bezpečná platba",
    "trust.payment.desc": "Šifrované transakce přes Stripe",
    "trust.tracking": "Živé sledování",
    "trust.tracking.desc": "Vidíš polohu řidiče v reálném čase",
    "trust.support": "Podpora",
    "trust.support.desc": "Kontakt přes chat nebo e-mail",
    "quickstart.title": "Začni za 30 sekund",
    "quickstart.step1": "Zadej e-mail a heslo",
    "quickstart.step2": "Ověř e-mailem",
    "quickstart.step3": "Najdi nebo nabídni jízdu",
    "quickstart.cta": "Vytvořit účet",
    "download.title": "Měj TakeMe vždy po ruce",
    "download.desc": "Přidej si aplikaci na domovskou obrazovku. Rychlejší přístup, push notifikace i offline.",
    "download.cta": "Jak nainstalovat",
  },
  en: {
    "hero.badge_online": "online",
    ...
    "trust.verified.desc": "Every user email-verified",
    "trust.payment": "Secure payment",
    "trust.payment.desc": "Encrypted transactions via Stripe",
    "trust.tracking": "Live tracking",
    "trust.tracking.desc": "See driver location in real time",
    "trust.support": "Support",
    "trust.support.desc": "Reach us via chat or email",
    "quickstart.title": "Get started in 30 seconds",
    "quickstart.step1": "Enter email and password",
    "quickstart.step2": "Confirm your email",
    "quickstart.step3": "Find or offer a ride",
    "quickstart.cta": "Create account",
    "download.title": "Keep TakeMe in your pocket",
    "download.desc": "Add the app to your home screen for faster access, push notifications and offline use.",
    "download.cta": "How to install",
  },
  pl: {
    "hero.badge_online": "online",
    ...
    "free.badge": "Rejestracja jest darmowa — brak ukrytych opłat",
    "coverage.title": "Gdzie działa",
    "coverage.desc": "TakeMe łączy ludzi w całej Europie Środkowej. Niezależnie od tego, czy podróżujesz w kraju, czy za granicą.",
    "faq.title": "Najczęściej zadawane pytania",
    "faq.q1": "Czy rejestracja jest darmowa?",
    "faq.a1": "Tak, założenie konta jest całkowicie darmowe. Płacisz dopiero, gdy rezerwujesz miejsce w samochodzie.",
    "faq.q2": "Skąd wiem, że przejazd jest bezpieczny?",
    "faq.a2": "Każdy profil jest weryfikowany e-mailem. Kierowcy mają oceny od innych pasażerów, a podczas przejazdu dostępne jest śledzenie na żywo.",
    "faq.q3": "Gdzie mogę podróżować?",
    "faq.a3": "TakeMe działa na Słowacji, w Czechach, w Polsce i innych krajach UE. Podróże między miastami i przez granice.",
    "faq.q4": "Jak działa płatność?",
    "faq.a4": "Płatność odbywa się bezpiecznie przez Stripe bezpośrednio w aplikacji. Środki są uwalniane kierowcy dopiero po zakończeniu przejazdu.",
    "trust.title": "Bezpieczeństwo przede wszystkim",
    "trust.verified": "Zweryfikowane profile",
    "trust.verified.desc": "Każdy użytkownik zweryfikowany e-mailem",
    "trust.payment": "Bezpieczna płatność",
    "trust.payment.desc": "Szyfrowane transakcje przez Stripe",
    "trust.tracking": "Śledzenie na żywo",
    "trust.tracking.desc": "Widzisz lokalizację kierowcy w czasie rzeczywistym",
    "trust.support": "Wsparcie",
    "trust.support.desc": "Kontakt przez chat lub e-mail",
    "quickstart.title": "Zacznij w 30 sekund",
    "quickstart.step1": "Wpisz e-mail i hasło",
    "quickstart.step2": "Potwierdź e-mailem",
    "quickstart.step3": "Znajdź lub zaproponuj przejazd",
    "quickstart.cta": "Załóż konto",
    "download.title": "Miej TakeMe zawsze pod ręką",
    "download.desc": "Dodaj aplikację do ekranu głównego. Szybszy dostęp, powiadomienia push i offline.",
    "download.cta": "Jak zainstalować",
  },
};
